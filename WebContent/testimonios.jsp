    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center"><strong>TESTIMONIOS</strong>
                    </h2>
                    <hr>
                </div>
				<div class="col-lg-12 text-center">
					...
					<p>Por culpa de una entrometida había perdido mi esposo,
						gracias a la oración y al espíritu santo, él ahora esta aquí
						conmigo, somos una familia felíz, también tengo muy buena suerte y
					...
					<p>Desde que llegue a Estados Unidos mi vida se torno muy
						difícil, yo vengo de honduras y contacté a los maestros que me
