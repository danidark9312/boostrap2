        ...
        <div class="row">
            <div class="box">
				...
				<div class="col-lg-12 text-center">
					...
					<hr>
					<h2 class="intro-text text-center">COMO REALIZAR LA LIMPIA ESPIRITUAL</strong>
					</h2>
					<hr>
					
					<div class="centerImage">
						<img src="img/limpiaEspiritual/limpiaMain.png" style="width: 80%" />
					</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="centerImage">
								<img src="img/limpiaEspiritual/lonely.png" style="width: 60%" />
							</div>
						</div>
					</div>
					<hr>
